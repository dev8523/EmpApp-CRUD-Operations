...
function validform() {
    ...
    var a = document.forms["my-form"]["emp_password"].value;
    var b = document.forms["my-form"]["first_name"].value;
    var c = document.forms["my-form"]["last_name"].value;
    var d = document.forms["my-form"]["emp_sal"].value;
